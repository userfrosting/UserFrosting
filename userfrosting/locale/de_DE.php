...
$lang = array_merge($lang,array(
	...
	"MAIL_TEMPLATE_DIRECTORY_ERROR" => "E-Mail-Vorlagen Verzeichnis kann nicht geöffnet werden. Versuchen Sie, E-Mail-Vorlagen Verzeichnis '{{name}}'",
...
$lang = array_merge($lang,array(
	...
	"PAGE_ACCESS_REMOVED" => "Seiten Zugriff für '{{name}}' Berechtigungsstufe(n) entzogen",
	"PAGE_ACCESS_ADDED" => "Seite Zugriff für '{{name}}' Berechtigungsstufe(n) gewährt",
