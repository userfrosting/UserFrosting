...
class Plugins {
    ...
    protected $_plugin_uri;    // the root URI of the plugin directory
    protected $_plugin_path;   // the root filesystem path of the plugin directory

    public function __construct($plugin_uri, $plugin_path){
        $this->_plugin_uri =  $plugin_uri;
