...
// Mass update all characters in the database.
...
if (!securePage($_SERVER['PHP_SELF'])){
  addAlert("danger", "Whoops, looks like you don't have permission to use the mass update script.");
...
//grab the armory link from the db

//grab user information based on armory link

//insert new updated info into the db
