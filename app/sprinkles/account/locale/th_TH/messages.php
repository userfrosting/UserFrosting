...
return [
    "ACCOUNT" => [
        ...
        "UNVERIFIED" => "บัญชีของคุณยังไม่ได้รับยืนยัน กรุณาตรวจสอบกล่องอีเมลและจดหมายขยะของคุณสำหรับขั้นตอนการเปิดใช้งานบัญชี",
    ...
    "EMAIL" => [
        "INVALID"   => "ไม่พบบัญชีสำหรับ '{{email}}'",
        "IN_USE"    => "อีเมล '{{email}}' ได้ถูกใช้งานแล้ว"
    ],

    "FIRST_NAME" => "ชื่อจริง",

    "HEADER_MESSAGE_ROOT" => "คุณลงชื่อเข้าใช้ในฐานะผู้ใช้ราก",
