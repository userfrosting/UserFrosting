...
return [
    "ACCOUNT" => [
        ...
        "SETTINGS" => [
            "@TRANSLATION"  => "Редактировать профиль",
    ...
    "REGISTRATION" => [
        ...
        "COMPLETE_TYPE2"    => "Вы успешно зарегистрировались. Ссылка для активации вашего аккаунта была отправлена на <strong>{{email}}</strong>.  Вы не будет сможете войти в систему до завершения этого шага.",
