...
return [
    'VALIDATE' => [
        ...
        'MAX_LENGTH'    => '{{label}} باید حداکثر {{max}} کاراکتر داشته باشد.',
        'MIN_LENGTH'    => '{{label}} باید حداقل {{min}} کاراکتر داشته باشد.',
        ...
        'RANGE'         => 'مقدار <strong>{{label}}</strong> باید بین {{min}} و {{max}} باشد.',
