...
return [
    'ERROR' => [
        ...
        '404' => [
            ...
            'RETURN'      => 'در هر حال، <a href="{{url}}">اینجا</a> کلیک کنید تا به صفحه اصلی بازگردید.'
        ],
        ...
        'CONFIG' => [
            ...
            'RETURN'      => 'لطفا خطاهای زیر را اصلاح کنید و سپس مجددا <a href="{{url}}">بارگذاری</a> نمایید.'
        ],
        ...
        'RETURN' => '<a href="{{url}}">اینجا</a> کلیک تا به صفحه اصلی بازگردید.',
