...
return [
    'VALIDATE' => [
        ...
        'LENGTH_RANGE' => '{{label}} deve ter entre {{min}} e {{max}} caracteres.',
        'MAX_LENGTH' => 'O {{label}} deve ter no máximo {{max}} caracteres.',
        'MIN_LENGTH' => 'O {{label}} deve ter no mínimo {{min}} caracteres.',
        ...
        'RANGE' => 'O valor para <strong>{{label}}</strong> deve ter entre {{min}} e {{max}}.',
