...
class BelongsToManyThroughTest extends TestCase
{
    ...
    function testPaginatedQuery()
    {
        ...
        $builder->shouldReceive('select')->once()->with('user_id')->andReturnSelf();
        $builder->shouldReceive('groupBy')->once()->with('user_id')->andReturnSelf();
        ...
        $collection->shouldReceive('pluck')->once()->with('user_id')->andReturn($collection);
        ...
        $builder->shouldReceive('whereIn')->once()->with('user_id', [1,2])->andReturnSelf();
