...
//Account
$lang = array_merge($lang,array(
	"ACCOUNT_SPECIFY_USERNAME" => "Por favor, ingrese su nombre de usuario", 
...
"ACCOUNT_INVALID_USER_ID"   => "No existe el identificador de usuario solicitado.",  
 "ACCOUNT_INVALID_PAY_TYPE" => "tipo de pago no es válida. Preste tipo debe ser 'cuota deducir' o 'hora'.", 
"ACCOUNT_USER_OR_EMAIL_INVALID" => "Nombre de usuario o dirección de correo electrónico no es válida", 
"ACCOUNT_USER_OR_PASS_INVALID" => "Nombre de usuario o contraseña no es válida", 
...
"ACCOUNT_INACTIVE" => "Su cuenta está en activo. Compruebe su carpeta de mensajes de correo electrónico / correo no deseado para ver las instrucciones de activación de la cuenta", 
"ACCOUNT_DISABLED" => "Esta cuenta ha sido inhabilitada. Póngase en contacto con nosotros para obtener más información.", 
"ACCOUNT_USER_CHAR_LIMIT" => "Su nombre de usuario debe estar entre %m1% y %m2% caracteres de longitud", 
"ACCOUNT_DISPLAY_CHAR_LIMIT" => "Su nombre de usuario debe estar entre %m1% y %m2% caracteres de longitud", 
"ACCOUNT_PASS_CHAR_LIMIT" => "La contraseña debe tener entre %m1% y %m2% caracteres de longitud", 
"ACCOUNT_TITLE_CHAR_LIMIT" => "Los títulos deben estar entre %m1% y %m2% caracteres de longitud", 
"ACCOUNT_PASS_MISMATCH" => "Su contraseña y confirmación de contraseña debe coincidir", 
"ACCOUNT_DISPLAY_INVALID_CHARACTERS" => "Nombre para mostrar sólo pueden incluir caracteres alfanuméricos", 
"ACCOUNT_USERNAME_IN_USE" => "Usuario %m1% ya está en uso", 
"ACCOUNT_DISPLAYNAME_IN_USE" => "Nombre para mostrar %m1% ya está en uso", 
"ACCOUNT_EMAIL_IN_USE" => "Correo electrónico %m1% ya está en uso", 
...
"ACCOUNT_NEW_PASSWORD_LENGTH" => "Nueva contraseña debe tener entre %m1% y %m2% caracteres de longitud", 
...
"ACCOUNT_ACTIVATION_MESSAGE" => "Usted tendrá que activar su cuenta antes de poder iniciar la sesión. Por favor siga el siguiente enlace para activar su cuenta.\n \ n %m1%activate_user.php?token=%m2%", 
"ACCOUNT_CREATION_COMPLETE"  => "Se ha creado la cuenta de usuario nuevo %m1%.", 
...
"ACCOUNT_TOKEN_NOT_FOUND" => "Token no existe / La cuenta ya está activada", 
"ACCOUNT_USER_INVALID_CHARACTERS" => "Nombre de usuario sólo pueden incluir caracteres alfanuméricos", 
     ...
     "ACCOUNT_DISABLE_SUCCESSFUL" => "Cuenta se ha desactivado con éxito.", 
     "ACCOUNT_ENABLE_SUCCESSFUL" => "Cuenta se ha permitido con éxito.",
     "ACCOUNT_DELETIONS_SUCCESSFUL" => "Usted ha eliminado correctamente m1%% usuarios", 
"ACCOUNT_MANUALLY_ACTIVATED" => "Cuenta %m1% 's se ha activado de forma manual", 
...
//Configuration
$lang = array_merge($lang,array(
	"CONFIG_NAME_CHAR_LIMIT" => "Nombre del sitio debe estar entre %m1% y %m2% caracteres de longitud", 
"CONFIG_URL_CHAR_LIMIT" => "url del sitio debe estar entre %m1% y %m2% caracteres de longitud", 
"CONFIG_EMAIL_CHAR_LIMIT" => "El correo electrónico del sitio debe estar entre %m1% y %m2% caracteres de longitud", 
"CONFIG_TITLE_CHAR_LIMIT" => "Nuevo título de usuario debe estar entre %m1% y %m2% caracteres de longitud", 
     "CONFIG_ACTIVATION_TRUE_FALSE" => "de activación de correo electrónico debe ser` true `o` false `", 
"CONFIG_REGISTRATION_TRUE_FALSE" => "El registro de usuarios debe ser` true `o` false `", 
     "CONFIG_ACTIVATION_RESEND_RANGE" => "Umbral de activación debe estar entre %m1% y %m2% horas", 
"CONFIG_LANGUAGE_CHAR_LIMIT" => "Idioma debe estar entre %m1% y %m2% caracteres de longitud", 
"CONFIG_LANGUAGE_INVALID" => "No hay archivo para el idioma clave `%m1%`", 
"CONFIG_TEMPLATE_CHAR_LIMIT" => "ruta de plantilla debe estar entre %m1% y %m2%  caracteres de longitud", 
...
"CONFIG_INVALID_URL_END" => "Por favor, incluya `/` al final /n en la URL de su sitio", 
"CONFIG_UPDATE_SUCCESSFUL" => "Configuración de su sitio se ha actualizado. Usted puede tener que cargar una nueva página para que todos los valores entren en efecto",
));
...
"FORGOTPASS_REQUEST_CANNED" => "petición de contraseña perdida cancelado", 
...
$lang = array_merge($lang,array(
	...
	"MAIL_TEMPLATE_DIRECTORY_ERROR"		=> "Imposible abrir directorio con plantillas de correo. Intenta cambiar el directorio a %m1%",
...
"PAGE_ACCESS_REMOVED" => "Página eliminado debido a que el nivel de permiso de acceso de %m1% (s)", 
"PAGE_ACCESS_ADDED" => "La página %m% fue añadida para el nivel de permiso de acceso (s)", 
     "ACCESS_DENIED" => "Hmm, parece que usted no tiene permiso para hacer eso.",
	));

//Permissions
$lang = array_merge($lang,array(
	"PERMISSION_CHAR_LIMIT" => "Los nombres de permisos deben estar entre %m1% y %m2% caracteres de longitud", 
"PERMISSION_NAME_IN_USE" => "Permiso name %m1% ya está en uso", 
